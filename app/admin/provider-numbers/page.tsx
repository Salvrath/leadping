  ...
  return <main style={{minHeight:"100vh",background:"#f4f7fb",padding:"28px clamp(16px,5vw,72px)",color:"#10213f"}}>
    <div style={{maxWidth:1050,margin:"0 auto"}}><Link href="/admin">← Till driftpanelen</Link>
      <section style={{background:"white",border:"1px solid #dbe4ef",borderRadius:18,padding:28,marginTop:20}}>
        <h1>46elks-nummerpool</h1><p>Endast nummer där både voice- och SMS-webhooken redan är konfigurerade får läggas till. Ett ledigt nummer reserveras automatiskt efter att kunden har registrerat sin betalmetod. Debitering startar först efter godkänd anslutning.</p>
        <div style={{background:waiting?"#fff7ed":"#f0fdf4",padding:14,borderRadius:12,margin:"18px 0"}}><strong>{waiting || 0}</strong> beställningar med sparad betalmetod väntar på nummer.</div>
