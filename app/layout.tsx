...
import { MarketingEventSink } from "@/components/marketing-event-sink";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="sv"><body><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(organization)}}/><a className="skip" href="#main">Hoppa till innehållet</a>{children}<CookieBanner/><PageTracker/><MarketingEventSink/><GoogleTagManager/><GoogleAdsConversion/><VercelAnalytics/></body></html>;
}